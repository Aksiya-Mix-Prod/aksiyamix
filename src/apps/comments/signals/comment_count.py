...
from apps.comments.tasks.celery_count_comments import \
    update_discount_comment_count


@receiver(post_save, sender=Comment)
def update_discount_comment_count_on_save(sender, instance, created, **kwargs) -> None:
    """
...
def decrement_discount_comment_count_on_delete(sender, instance, **kwargs):
    """
